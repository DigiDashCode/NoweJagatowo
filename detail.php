...
if ($id > 0) {
    $stmt = $pdo->prepare(
        "SELECT h.id, h.title, h.description, h.price, h.location, h.bedrooms, h.bathrooms, h.area, h.status, COALESCE(hi.url, 'https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=1000&q=80') AS image_url
         FROM houses h
